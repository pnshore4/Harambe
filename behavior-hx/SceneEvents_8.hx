	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				g.drawString("" + "Harambe lives to see another day!", 100, 150);
				g.drawString("" + "The world did not lose another hero.", 100, 200);
				g.drawString("" + "Harambe is the hero we need, not the one we deserve", 100, 270);
			}
		});
